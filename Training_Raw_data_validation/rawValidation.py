...
class Raw_Data_validation:
    """
            This class shall be used for handling all the validation done on Raw Training Data!!.
    ...
    def valuesFromSchema(self):
        ...
        :return: LengthOfDataStampInFile LengthOfTimeStampFile, column_names, Number of columns
        """
        ...
        try:
            ...
            message = "LenghthOfDateStampInFile:: %s" % LengthOfDateStampInFile + '\t' + "LengthOfTimeStampInFile :: %s" % LengthOfTimeStampInFile + '\t' +"NumberofColumns :: %s"% NumberofColumns + "\n"
